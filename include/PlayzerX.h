 ...
 * \version 2.0.1.0
 *
 * The PlayzerX library facilitates communication with PlayzerX-compatible devices
...
class DLLEXPORT PlayzerX
{
   public:
	 ...
	 * \return The version string, e.g., "2.0.1.0".
	 */
	std::string GetAPIVersion() { return "2.0.1.0"; };
   ...
   protected:
	...
	/** \brief Indicates if the device supports RGB data format. */
	bool m_RGBCapable;
